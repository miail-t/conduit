            ...
            <div className={style.articlePage} >
                {article ? <>
                    <div className={style.articleBody}>
                        ...
                        <div className={style.tagWrap} >{article.tagList.map((tag: string) => { return <span className={style.tag} >{tag}</span> })}</div>
                    </div>
                    <div className={style.about} >
                        ...
                        <FavoritesCount slug={article.slug} favorited={article.favorited} favoritesCount={article.favoritesCount} />
                    </div>
                </>
                    : <Spinner />}
